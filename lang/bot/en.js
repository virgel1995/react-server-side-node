module.exports = {
	...
	ADMIN: {
		...
		DEAFEN_ALREADY_DEAFENED:
			'User is not in a voice channel or is already deafened',
		DEAFEN_SUCCESS:
			'{member} was successfully deafenned from the server. Reason: **{reason}**. I have also send a DM letting the person know.',
		DEAFEN_SUCCESS_DM:
			"You've been **Deafenned** from **{guild}**, Reason: **{reason}**",
		DELETE_PROVIDE_AMOUNT:
			'Amount must be a valid number and between 0 below 100',
		...
		KICK_SUCCESS_DM:
			"You've been **kicked** from **{guild}**, Reason: **{reason}**",
		KICK_SUCCESS:
		...
		MUTE_SUCCESS_DM:
			"You've been **muted** from **{guild}**, Reason: **{reason}**",
		MUTE_SUCCESS:
		...
		PROVIDE_COMMAND_OR_CATEGORY_NAME:
			'Please provide a command or category name',
		...
		MY_ROLE_MUST_BE_HIGHER2:
			'My role must be higher than **{needsRoleTag}** highest role!',
		YOUR_ROLE_NOT_HIGHT:
			'Your role is not high enough than **{roleName}** role!',
		...
		STICKY_READ:
			'__***:warning: Sticky Message, Read Before Typing! :warning:***__',
		...
		SUCCES_MUTED:
			'{muteMemberTag} was successfully muted for {time}. Reason: **{reason}**',
		PROVIDE_VALID_USERID: 'Please provide a user id',
		SUC_UNBAN:
			'**{bannedUsername}** was successfully unbanned from the server.',
		...
		YOU_DISC:
			"You've been **disconnected** from **{guildName}**, Reason: **{reason}**",
		USER_DISC:
		...
		YOU_MUTED:
			"You've been **Muted** from **{guildName}**, Reason: **{reason}**",
		USER_MUTED:
		...
		USER_WARNED:
			'{memberTag} was warned with reason: {reason} (Total warnings: {warningsTotal})',
		WARN_NOT_FOUND:
			"warning wasn't found or {memberTag} doesn't have any warnings",
		WARNING: 'Warning:',
		WARNED_ON: 'Warned on:',
	...
	EVENTS: {
		...
		CHANNEL_CREATED_MSG:
			'{channel_type}: **{channel}** was created \n BY : **{executor}**',
		CHANNEL_DELETED: 'Channel Deleted',
		CHANNEL_BLUKED: 'Channel Bluked',
		CHANNEL_DELETED_MSG:
			'{channel_type}: **{channel}** was deleted \n BY : **{executor}**',
		CHANNEL_RENAME_MSG:
			'{channel_type}: **{channel}** was renamed to **{new_channel}** \n BY : **{executor}**',
		...
		EMOJI_RENAMED_MSG:
			'Emoji: **{emoji_name}** was renamed to **{new_name}** ({emoji})',
